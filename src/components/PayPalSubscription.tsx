...
const PayPalSubscription: React.FC<PayPalSubscriptionProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  // UPDATED: handleSubscriptionSuccess with success screen
  const handleSubscriptionSuccess = async (data: any, actions: any) => {
    try {
      ...
      // Store success data for success screen
      ...
      setSuccessData(subscriptionData);
  ...
  // NEW: Handle success screen close
  ...
  return (
    <>
      {/* Main PayPal Subscription Modal */}
