...
export function StudentDashboard() {
  ...
  // Function to handle chat start with gamification
  const handleStartChat = async (topic?: string) => {
    try {
      // Award XP for starting a chat session
      await addXP(10, 'Started AI tutoring session');
      ...
      // Still allow navigation even if gamification fails
      try {
        window.location.href = '/chat';
      } catch (navError) {
        setShowChat(true);
  ...
  // Function to handle file upload with gamification
  const handleFileUpload = async () => {
    try {
      // Award XP for uploading work
      await addXP(15, 'Uploaded work for review');
      ...
      // Still allow upload even if gamification fails
      document.getElementById('file-upload')?.click();
    }
  };

  // Function to handle writing review with gamification
  const handleWritingReview = async () => {
    try {
      // Award XP for starting writing review
      await addXP(12, 'Started writing review session');
      ...
      console.error('Error tracking writing review:', error);
      // Still allow navigation even if gamification fails
      try {
        window.location.href = '/writing-review';
      } catch (navError) {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      color: 'bg-green-600',
      action: () => handleStartChat('document-review')
    },
    {
      id: 'review',
    ...
    },
    {
      ...
      action: async () => {
        try {
          await addXP(5, 'Visited discussion forum');
          window.location.href = '/forum';
        } catch (error) {
          console.error('Error tracking forum visit:', error);
          window.location.href = '/forum';
        }
      }
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-6 text-white">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => handleStartChat('document-review')}
                  className="w-full bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-4 py-3 rounded-lg transition-all flex items-center space-x-2"
                >
          ...
          <div className="space-y-6">
            ...
            <LeaderboardCard
              ...
              entries={[
                ...
                { id: '3', name: 'You', score: stats.xp, rank: 3, isCurrentUser: true },
      ...
      <input
        ...
        onChange={async (e) => {
          ...
          if (file) {
            try {
              await addXP(20, 'Successfully uploaded file for review');
              console.log('File uploaded:', file);
            } catch (error) {
              console.error('Error tracking file upload XP:', error);
            }
          }
        }}
      />
